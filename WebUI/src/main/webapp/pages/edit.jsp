...
<div class="container">
    ...
    <form:form action="${formUrl}" method="POST" modelAttribute="laptop" cssClass="col-md-8 col-md-offset-2">
        ...
        <div class="row">
            <div class="form-group">
                <form:input path="id" type="hidden" cssClass="form-control" id="laptop-id"/>
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <form:select path="status" items="${status}" cssClass="form-control" id="laptop-status"/>
            </div>
    ...
    <p> <a href="<spring:url value="/admin/"/>">View all laptops</a></p>
</div>
</body>
</html>